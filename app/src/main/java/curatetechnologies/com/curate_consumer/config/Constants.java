...
public class Constants {
    public static final String CURATE_SHARED_PREFERENCE_KEY="CURATE";
    public static final String USER_SHARED_PREFERENCE_KEY="User";
    public static final String RADIUS_SHARED_PREFERENCE_KEY="Radius";
